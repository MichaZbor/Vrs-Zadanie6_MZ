...
static uint8_t (* LPS25HB_i2c_mread_single)(uint8_t register_addr, uint8_t slave_addr, uint8_t read_flag) = 0;
static void (* LPS25HB_i2c_mread_multi)(uint8_t*buff, uint8_t len, uint8_t register_addr, uint8_t slave_addr, uint8_t read_flag) = 0;
static void (* LPS25HB_i2c_mwrite)(uint8_t *buff, uint8_t len, uint8_t register_addr, uint8_t slave_addr, uint8_t read_flag) = 0;
